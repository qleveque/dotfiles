...
execute 'highlight CocErrorSign gui=bold guifg=red guibg='.LIGHTEST_BG
execute 'highlight CocWarningSign gui=bold guifg=orange guibg='.LIGHTEST_BG
execute 'highlight CocHintSign gui=bold guifg=green guibg='.LIGHTEST_BG
execute 'highlight CocInfoSign gui=bold guifg=blue guibg='.LIGHTEST_BG
