...
" Standard
set encoding=UTF-8 ffs=unix,dos,mac nobackup nowritebackup noswapfile undofile
...
com -nargs=+ CT :exe 'sil !zsh -ic "cht '.&filetype.' '.join([<f-args>],' ').'"'
cnoreabbrev cht CT|cnoreabbrev ef EF
